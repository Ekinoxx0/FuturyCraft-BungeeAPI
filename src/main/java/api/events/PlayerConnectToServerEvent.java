...
public class PlayerConnectToServerEvent extends Event
{
	...
	public PlayerConnectToServerEvent(Server server, UserData user, ConnectionCause cause, Server switchTo)
	{
		this.server = server;
		this.user = user;
		this.cause = cause;
	...
	public boolean equals(Object o)
	{
		...
		PlayerConnectToServerEvent that = (PlayerConnectToServerEvent) o;
